...
export interface IMoolaLendingPoolInterface extends Interface {
  getFunction(
    nameOrSignature: "deposit" | "getUserAccountData" | "withdraw"
  ): FunctionFragment;
...
export interface IMoolaLendingPool extends BaseContract {
  connect(runner?: ContractRunner | null): IMoolaLendingPool;
  waitForDeployment(): Promise<this>;

  interface: IMoolaLendingPoolInterface;
