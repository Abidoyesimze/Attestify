...
export default function DeploymentStatus({ className = '' }: DeploymentStatusProps) {
  ...
  return (
    <div className={`bg-white rounded-lg shadow-lg p-5 sm:p-6 ${className}`}>
      <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-3 sm:mb-4">Deployment Status</h3>
